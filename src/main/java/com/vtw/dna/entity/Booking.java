...
//    @Column(nullable = false, length = 10)
    ...
    public Booking(String userId, Long movieId, String cinema, Integer persons, LocalDateTime showTime) {
        this.user = user;
        this.movie = movie;
        this.cinema = cinema;
    ...
    public void setUser(String userId, String s, String s1, LocalDateTime now) {
    }
}
